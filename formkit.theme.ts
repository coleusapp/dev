...
/**
  ...
  *
  * @checksum - bd06cf22fcc036f53d8701d9f46e66b33ade8f886dec1328d2ba6bebe3f1d1cf
  * @variables - radius=rounded-lg,accentColor=violet,colorTemperature=gray,spacing=1.5,scale=sm,inputShadow=shadow-none,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=400,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:dark:border-gray-500": true
  },
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-gray-300": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-gray-300": true,
    "dark:group-data-[prefix-icon]:border-gray-400": true,
    "dark:group-data-[suffix-icon]:border-gray-400": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "dark:[&::-webkit-slider-runnable-track]:bg-gray-400/50": true,
    ...
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-gray-500": true,
    ...
    "dark:[&::-moz-range-track]:bg-gray-400/50": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "dark:group-data-[multiple]:border-gray-400": true,
  ...
  "rating__ratingItem": {
    ...
    "focus-within:outline-violet-500": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true
  },
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-gray-300": true,
    "dark:[&>div>div::after]:bg-gray-400": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=tab]/wrapper:border-gray-200": true,
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-gray-500": true,
    ...
    "group-data-[tab-style=progress]/wrapper:group-data-[hide-labels=true]/wrapper:mb-3": true
  },
  "multi-step__tab": {
    "group/tab": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-gray-500": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:after:bg-gray-500": true,
